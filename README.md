...
Admin Video Overview: https://drive.google.com/file/d/1AFZDit07_ozKctIBxMr0d5oGjXZOqov7/view

Brief Overview: The Half Caf Web App is a website for TEACHERS to order drinks of their choice. There are 3 ends: user, admin, and barista. The users are teachers who can order drinks. Baristas are students who work in the half caf and can see the orders pop up in real time. The admin as of right now is Mr. Skarr and can make all kinds of modifications to drinks and users. The admin features will be highlighted in more detail in a video.

Here is our demo presentation that covers everything in detail: (the video is helpful)
https://docs.google.com/presentation/d/1TU9OVrhfbkIvV1Q-GQ6FCpBbiwiiSpgY0o57qSD1cMc/edit?usp=sharing 
...
Branches: For each task/story, create a new branch titled something about that branch (ex: branch to cancel orders for barista, branch name is “cancel order barista”. Do NOT do all your work into main. At the end, when you complete the task, you can squash and merge your task branch with the main branch, so all your work will be in the server that way
